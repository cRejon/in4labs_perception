In4Labs - Perception Systems remote lab [![CC BY-NC-SA 4.0][cc-by-nc-sa-shield]][cc-by-nc-sa]
=====
# Description
Implementation of the  Perception Systems lab inside a Docker image that will be run by the tools [In4Labs base LTI tool](https://github.com/cRejon/in4labs) (if using a LMS such as Moodle) or [In4Labs base auth tool](https://github.com/cRejon/in4labs_auth) (if basic authentication is desired).  
Tested on Raspberry Pi OS Lite Bullseye (64-bit). Requires Python >=3.9.

# Installation
This lab uses an [Arduino Mega 2560 Rev3](https://docs.arduino.cc/hardware/mega-2560/) board to perform the experiments. Connect the board to the Raspberry Pi according to its **_'usb_port'_** variable inside the app _config.py_ file. This variable can be changed if more laboratories are installed on the same Raspberry Pi.
```
